...
(function($) {
    $.showYtVideo = function(options) {
        ...
        var modal = $('<div class="youtube-modal size-' + options.modalSize + '"></div>');
        var closeButton = $('<div class="youtube-modal-close">&#215;</div>');

        if (options.closeButton) {
            closeButton.appendTo(modal);
        }

        var modalBg = $('<div class="youtube-modal-bg"></div>');
