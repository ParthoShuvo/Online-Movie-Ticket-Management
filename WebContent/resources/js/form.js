...
$(function() {
	...
	$('#contact-form')
			.submit(
					function(e) {
						...
						$(
								'<p class="success"><span class="success-huge">Thank you!</span> <br> your message successfully sent</p>')
								.appendTo(self).hide().delay(300).fadeIn();
			...
			.submit(
					function(e) {
						...
						if ($pass.val().length > 1
								&& $pass.val() != $pass.attr('placeholder')) {
						...
						$(
								'<p class="login__title">sign in <br><span class="login-edition">welcome to A.Movie</span></p><p class="success">You have successfully<br> signed in!</p>')
								.appendTo(self).hide().delay(300).fadeIn();

						// var formInput = self.serialize();
						// $.post(self.attr('action'),formInput,
	...
	function createErrTult(text, $elem) {
		...
		$(
				...
				.insertAfter($elem).delay(4000).animate({
					'opacity' : 0
				}, 300, function() {
